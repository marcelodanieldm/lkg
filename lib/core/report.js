...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .fuente{font-size:12.5px;color:var(--suave);background:#f4f6f9;border-radius:7px;padding:9px 11px;margin-top:10px}
  ...
  .cta a{display:inline-block;background:#fff;color:var(--tinta);text-decoration:none;font-weight:600;padding:11px 20px;border-radius:9px;margin-top:8px}
...
<h2><span class="n">01</span>Cómo se reparte el puntaje</h2>
...
<h2><span class="n">02</span>Lo que ya está bien resuelto</h2>
...
<h2><span class="n">${topFortalezas.length ? '03' : '02'}</span>Puntos a mejorar</h2>
...
<h2><span class="n">${topFortalezas.length ? '04' : '03'}</span>Lo que no pudimos verificar</h2>
...
/** Versión corta para el cuerpo del email/WhatsApp. */
