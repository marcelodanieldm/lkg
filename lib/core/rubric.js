    ...
    reglas: [
      {
        ...
        comparativo: 'en búsquedas por rubro, Google muestra primero a quienes declararon la categoría exacta.',
        comoSeArregla: {
      ...
      },
      {
        ...
        comparativo: 'al buscar servicios específicos, los competidores aparecen en más consultas relacionadas.',
        comoSeArregla: {
          donde: 'Perfil de negocio en Google Maps › Editar perfil › Categoría de negocio',
          pasos: [
      ...
      },
      {
        ...
        comparativo: 'alguien que busca desde el celular ve el botón directo de llamada en el competidor y en tu perfil no.',
        comoSeArregla: {
      ...
      },
      {
        ...
        comparativo: 'el cliente puede ingresar a la web del competidor para ver detalles antes de elegir.',
        comoSeArregla: {
    ...
    reglas: [
      {
        ...
        evaluar: (p) => {
          if (p.fotosEsUnPiso) return { ratio: null, estado: 'nd', evidencia: 'Al menos 10 fotos detectadas (la API pública no informa más de 10 fotos).' };
  ...
  },
  {
    ...
    reglas: [
      ...
      },
      {
        ...
        evaluar: (p) => {
          if (p.servicios == null) return { ratio: null, estado: 'nd', evidencia: 'El catálogo de servicios o menú no es expuesto por la API pública; requiere captura asistida.' };
  ...
  },
  {
    ...
    reglas: [
      ...
      },
      {
        ...
        evaluar: (p) => {
          if (!p.sitioWeb || !p.web || p.web.ok !== true) return { ratio: null, estado: 'nd', evidencia: 'Las redes sociales se detectan analizando el sitio web; requiere un sitio web accesible.' };
          const r = p.redes || {};
...
/** Lista plana de las 25 reglas de la rúbrica. */
export const REGLAS = DIMENSIONES.flatMap(d => d.reglas);
